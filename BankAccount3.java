...
public class BankAccount3 {
    ...
    private AtomicInteger cActionIncrement;
    private final Lock cLock;

    public BankAccount3() {
        cAccountOwner = "The Bank";
        cBankBalance = 0;
        cActionIncrement = new AtomicInteger();
        cLock = new ReentrantLock();
    }

    public BankAccount3(String accountOwner, double bankBalance) {
    ...
    public void incrementCounter() {
        cActionIncrement.incrementAndGet();
    }
}
